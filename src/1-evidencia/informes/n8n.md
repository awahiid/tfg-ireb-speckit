...
|---|---|---|---|---|---|
| n8n-31253 | 2.25.1 | `core: Align /credentials/for-workflow response with its frontend type` | #31253 | https://github.com/n8n-io/n8n/releases/tag/n8n@2.25.1 | path explícito + contrato de respuesta |
| n8n-31349 | 2.25.1 | `editor, core: Enhance source control endpoint access control` | #31349 | https://github.com/n8n-io/n8n/releases/tag/n8n@2.25.1 | endpoint + control de acceso |
| n8n-31507 | 2.25.1 | `editor: Hide private credential connect controls without update permission` | #31507 | https://github.com/n8n-io/n8n/releases/tag/n8n@2.25.1 | condición + permisos + UI |
| n8n-30375 | 2.25.1 | `Email Trigger (IMAP) Node: Fix emails marked as read without triggering workflow` | #30375 | https://github.com/n8n-io/n8n/releases/tag/n8n@2.25.1 | condición + flujo trigger |
| n8n-31371 | 2.25.1 | `MongoDB Node: Validate update key value type` | #31371 | https://github.com/n8n-io/n8n/releases/tag/n8n@2.25.1 | validación técnica clara |
| n8n-31374 | 2.25.1 | `Only allow specified AWS regions` | #31374 | https://github.com/n8n-io/n8n/releases/tag/n8n@2.25.1 | restricción funcional concreta |
| n8n-30528 | 2.25.1 | `Postgres Node: Return empty array for SELECTs that match no rows` | #30528 | https://github.com/n8n-io/n8n/releases/tag/n8n@2.25.1 | output explícito + condición |
| n8n-30809 | 2.25.1 | `Salesforce Trigger Node: Stop Created triggers refiring on record updates` | #30809 | https://github.com/n8n-io/n8n/releases/tag/n8n@2.25.1 | trigger + condición muy clara |
| n8n-31071 | 2.25.1 | `Send Email Node: Allow non-inline file attachments` | #31071 | https://github.com/n8n-io/n8n/releases/tag/n8n@2.25.1 | capacidad funcional directa |
| n8n-31212 | 2.25.1 | `Stripe Trigger Node: Use stored webhook secret for request verification` | #31212 | https://github.com/n8n-io/n8n/releases/tag/n8n@2.25.1 | verificación + secreto + webhook |
