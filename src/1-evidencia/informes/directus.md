...
|---|---|---|---|---|---|
| directus-26976 | v11.17.1 | `Added keyboard navigation to the cards layout (#26976 by @HZooly)` | #26976 | https://github.com/directus/directus/releases/tag/v11.17.1 | UI observable clara |
| directus-26836 | v11.17.1 | `Added native Tabs group interface. Uninstall the extension if currently using it to avoid unintended side effects. (#26836 by @bryantgillespie)` | #26836 | https://github.com/directus/directus/releases/tag/v11.17.1 | interfaz + condición explícita |
| directus-26886 | v11.17.1 | `Added bulk folder deletion from the files grid with move-up or delete-all options (#26886 by @HZooly)` | #26886 | https://github.com/directus/directus/releases/tag/v11.17.1 | acción UI muy concreta |
| directus-26965 | v11.17.1 | `Used shorter tooltip delay for disabled elements (#26965 by @HZooly)` | #26965 | https://github.com/directus/directus/releases/tag/v11.17.1 | comportamiento UI identificable |
| directus-26772 | v11.16.0 | `Added support for a global draft version that is automatically available for all items when versioning is enabled (#26772)` | #26772 | https://github.com/directus/directus/releases/tag/v11.16.0 | condición + datos/versionado |
| directus-26669 | v11.15.4 | `Fixed translation interface being disabled when delete permission not allowed (#26669 by @AlexGaillard)` | #26669 | https://github.com/directus/directus/releases/tag/v11.15.4 | condición + permisos + UI |
| directus-26668 | v11.15.4 | `Fixed item comparison failing when special characters are present in manual primary keys (#26668 by @AlexGaillard)` | #26668 | https://github.com/directus/directus/releases/tag/v11.15.4 | condición explícita + datos |
| directus-26676 | v11.15.4 | `Fixed non-editable state for relational fields with custom permissions (#26676 by @HZooly)` | #26676 | https://github.com/directus/directus/releases/tag/v11.15.4 | permisos + campos relacionales |
| directus-26646 | v11.15.4 | `Added restriction of allowed MIME types to the system file upload interface (#26646 by @AlexGaillard)` | #26646 | https://github.com/directus/directus/releases/tag/v11.15.4 | validación + interfaz de subida |
| directus-26638 | v11.15.3 | `Added activity logging for explicit user logout (#26638 by @JamesW1)` | #26638 | https://github.com/directus/directus/releases/tag/v11.15.3 | auth + logging + actor |
