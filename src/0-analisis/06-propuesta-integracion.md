...
## 6.3 Propuesta general: Preset IREB para SpecKit

Para la comunidad SpecKit, se podría crear un preset que añada conciencia IREB al flujo:

### `speckit.specify` con atributos IREB
