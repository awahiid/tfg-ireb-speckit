...
| **E — TSR (Test Satisfaction Rate)** | `diff.patch` + requisitos | Manual (inspección) | Medir qué porcentaje de requisitos de la especificación maestra satisface el código generado |
...
> 1. **Automática** (script `analisis-automatico.py`): estimación basada en
